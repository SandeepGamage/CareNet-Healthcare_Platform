...
import { Plus, Trash2, FileText, Calendar, User, ArrowLeft, Edit, X } from "lucide-react";
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="h-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_14px_40px_rgba(15,23,42,0.08)] ring-1 ring-blue-100/60 flex flex-col">
          <div className="border-b border-slate-100 bg-slate-50 px-6 py-4">
            ...
            <h2 className="mt-1 text-lg font-bold text-slate-800">Create Prescription for {selectedPatient.patientName}</h2>
          ...
          <div className="flex-1 p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={onInputChange}
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm bg-white"
                >
            ...
            <div>
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-sm transition-colors flex items-center justify-center gap-2"
            >
            ...
            {medications.length > 0 && (
              <div className="rounded-2xl border border-slate-200 overflow-hidden bg-slate-50/60">
                ...
                <div className="border-t border-slate-200 px-4 py-4">
                  ...
                  >
                    <FileText size={18} /> Submit Prescription
                  </button>
                </div>
              </div>
            )}
